# Contributing to isrp-linkml

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
isrp-linkml. These guidelines are not strict rules.
...
The isrp-linkml team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the isrp-linkml technical leads
...
[issues]: https://github.com/my-org/isrp-linkml/issues/
[pulls]: https://github.com/my-org/isrp-linkml/pulls/
